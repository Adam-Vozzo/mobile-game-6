...
func _build_screen_shake_tuning(vbox: VBoxContainer) -> void:
	vbox.add_child(_make_label("Screen Shake — Tuning", SECTION_FONT_SIZE, false))
	_make_slider(vbox, "Intensity ×",
		0.0, 3.0, 0.05,
